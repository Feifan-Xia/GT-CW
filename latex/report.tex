...
\subsection{1.1 Motivating Context}
...
\subsection{1.2 Normal-Form Game}
...
\section{2. Theoretical Analysis of the Stage Game}

\subsection{2.1 Pure Strategy Nash Equilibria}
...
\subsection{2.2 Mixed Strategy Nash Equilibrium}
...
\subsection{2.3 Welfare Analysis}
...
\section{3. Static Game Simulation}

\subsection{3.1 Numerical Verification of $p^*$}
...
\subsection{3.2 Attendance Distribution at $p^*$}
...
\section{4. Repeated Game Dynamics}

\subsection{4.1 Stage-Game Best-Reply Dynamics}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figure3_best_response.png}
...
\subsection{4.2 Inductive Strategies}
...
\section{5. Ablation and Sensitivity Analysis}

\subsection{5.1 Exploration vs. Exploitation}
...
\subsection{5.2 Predictor Count per Agent (K)}
...
\subsection{5.3 Contribution of Novel Predictors (Ablation)}
...
\subsection{5.4 Homogeneous vs. Heterogeneous Population}
...
\section{6. Real-World Applications and Discussion}

\subsection{6.1 Endogenous Coordination Without Communication}
...
\subsection{6.2 Implications for Navigation Systems and Congestion Policy}
...
\subsection{6.3 Model Limitations}
...
\section{7. Extensions: Non-Stationary Environments}
...
\subsection{7.1 The "Weekend Effect": Congestion Despite Reduced Demand}
